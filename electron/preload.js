...
contextBridge.exposeInMainWorld('petBridge', {
  ...
  onSetPet: (cb) => ipcRenderer.on('set-pet', (_e, data) => cb(data)),
  onAddPet: (cb) => ipcRenderer.on('add-pet', (_e, data) => cb(data)),
  onRemovePet: (cb) => ipcRenderer.on('remove-pet', (_e, data) => cb(data)),
  ...
  setFocusable: (canFocus) => ipcRenderer.send('set-focusable', canFocus),
